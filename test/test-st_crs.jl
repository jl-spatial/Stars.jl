...
@testset "wkt works" begin
    ...
    @testset "Projection string checking" begin
        ...
        # WKT string handling
        result = Stars.str2wkt(merc_wkt)
        @test result == merc_wkt

        # Invalid string
        @test_throws ArchGDAL.GDAL.GDALError Stars.str2wkt("INVALID")

    end

    # @testset "Check projection of file" begin
    #     ga = Stars.read("gdalworkshop/world.tif")
